          ...
          <div className="row">
            ...
            <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
              <div className="about__mid-7 text-anim">
                <p>
                  At NNRS, we understand the importance of accessible and
                  reliable healthcare. As a trusted pharmacy, we are driven by a
                  mission to enhance the well-being of individuals and
                  communities by delivering exceptional pharmaceutical care.
                </p>
                <p>
                  Our team of highly trained pharmacists and knowledgeable staff
                  is dedicated to ensuring the highest standards of safety,
                  efficacy, and personalized services Thank you for choosing
                  NNRS PHARMACEUTICALS We look forward to serving you and being
                  your trusted partner on your journey to optimal health and
                  well-being.f
                </p>
                <Image
                  priority
